  ...
  const translations = {
    ...
    zh: {
      ...
      hero: {
        ...
        title2: "行銷決策",
        summary:
          "emlyon 商學院碩士生，結合紮實的數據分析能力與對數位行銷及客戶體驗的高度熱忱。致力於協助品牌在數位行銷、績效優化與業務發展方面實現目標。",
        locationLabel: "現居地",
        locationValue: "法國里昂",
      ...
      financeHero: {
        ...
        title1: "融合",
        title2: "嚴謹分析與策略視野。",
        summary: "emlyon 商學院碩士生，具備經濟與管理雙主修背景，專注於財務建模、風險分析與複雜問題解決。善用 Excel 及商業智慧工具，提供結構化分析，支援企業轉型與價值創造。",
        ctaPrimary: "聯絡我",
        ctaSecondary: "查看我的經歷",
        cardRole: "財務 & 策略顧問",
