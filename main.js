  ...
  const translations = {
    fr: {
      ...
      resources: {
        ...
        ieltsOfficial: "Sujets d'entra簾nement et guides de préparation officiels de l'IELTS.",
        ...
        ted: "?coute avancée sur des sujets passionnants –utilisez la fonction transcription.",
      },
      pageNav: {
        home: "Accueil",
        overview: "Vue générale",
      ...
      teachingServices: {
        ...
        ielts: {
          ...
          desc: "Coaching complet pour les 4 modules. Stratégies de test, entra簾nement intensif et simulations d'examen, avec un suivi personnalisé de la progression.",
        ...
        exams: {
          ...
          desc: "Préparation structurée aux examens officiels Cambridge et au GEPT (?冽–望炎). Entra簾nement sur annales et méthodes pour chaque épreuve.",
          tag1: "YLE (Children)",
      ...
      teachingExp: {
        ...
        translation: {
          ...
          company: "Freelance · Projets Académiques & ?ditoriaux",
