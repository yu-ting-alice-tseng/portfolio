document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    ...
    fr: {
      ...
      hero: {                              // → index.html (section héro principal)
        ...
        availabilityValue: "janvier 2027 (stage de césure de 6 mois)",
      ...
      skills: {                            // → index.html / finance.html / marketing.html / data.html
        ...
        chipMarketingAutomation: "Marketing Automation",
        chipDesign: "Rédaction de Contenu & Design Visuel",
        ...
        blockContent: "Content & Community",
        subContent1: "Stratégie",
        subContent2: "SMM (Marketing sur les Réseaux Sociaux)",
        filterEvents: "Événementiel",
        blockEvents: "Événementiel & Coordination",
        chipEventManagement: "Organisation d'événements",
        chipEventHosting: "Présidence & Animation",
        chipVendorCoordination: "Coordination avec Prestataires",
      ...
      financeHero: {                       // → finance.html (section héro)
        kicker: "Finance · Contrôle de Gestion · Analyse",
        title1: "Compter, vérifier",
        title2: "et rendre les chiffres lisibles.",
        summary: "Cours de finance et de contrôle de gestion à emlyon (comptabilité, analyse de P&L, modélisation, analyse des écarts) et une mineure en économie à NCCU. Côté terrain : budgets publicitaires mensuels chez KPN et suivi des engagements pris auprès des annonceurs chez leboncoin.",
        ctaPrimary: "Me contacter",
        ctaSecondary: "Voir mes expériences",
      ...
      marketingHero: {                     // → marketing.html (section héro)
        kicker: "Contenu · Campagnes · Diffusion",
        cordierTitle: "Résultats de campagnes",
        corde1: "+93,3 % de vues · Engoo",
        corde2: "+89,1 % d'interactions · Engoo",
        corde3: "+69,7 % d'abonnés · Engoo",
        corde4: "+9,5 % de CTR · KPN",
        corde5: "+5,1 % de conversion · KPN",
        title1: "Je conçois des contenus",
        title2: "et je pilote leur diffusion.",
        summary: "Chez Engoo, j'ai tenu le compte Xiaohongshu pendant trois mois : +93,3% de vues et +69,7% d'abonnés. Chez KPN, j'ai suivi les campagnes Meta et Google (+9,5% de CTR, +5,1% de taux de conversion). Depuis juillet 2026, je mets en ligne et j'optimise des campagnes display chez leboncoin.",
      ...
      dataHero: {                          // → data.html (section héro)
        kicker: "Analyse · Reporting · Méthodes quantitatives",
        title1: "Tableaux de bord, régressions",
        title2: "et rapports de campagne.",
        summary: "Excel (TOSA 950/1000), Python, R, SQL, Power BI et Tableau. Un tableau de bord quotidien de 12 métriques chez Engoo, une étude par régressions sur les facteurs de positionnement Google chez KPN, et aujourd'hui les rapports de diffusion des campagnes display chez leboncoin.",
      ...
      experience: {                        // → index.html / marketing.html / data.html / finance.html
        ...
        leboncoin: {
          ...
          title: "Mediatrading / AdOps",                 // point1-3 → index.html | mkPoint → marketing.html
          company: "leboncoin · Régie publicitaire",
          point1: "Mise en ligne des campagnes display et suivi opérationnel de leur diffusion.",
          point2: "Suivi et optimisation d'un portefeuille de campagnes.",
          point3: "Rapports de mise en ligne, bilans de campagnes et interface avec les équipes commerciales.",
          mkPoint1: "Piloter la mise en ligne des campagnes display et le bon déroulement de leur diffusion.",   // → marketing.html
          mkPoint2: "Optimiser un portefeuille de campagnes en cours de diffusion pour sécuriser l'atteinte des objectifs média.",
          mkPoint3: "Produire les bilans de campagnes pour restituer les performances aux annonceurs.",
          mkPoint4: "Travailler en lien étroit avec les équipes commerciales pour fluidifier les échanges entre l'annonceur et la régie.",
          dataPoint1: "Consolider les données de diffusion pour produire les rapports de mise en ligne et les bilans de campagnes.",   // → data.html
          dataPoint2: "Analyser les indicateurs de diffusion d'un portefeuille de campagnes pour identifier les leviers d'optimisation.",
          dataPoint3: "Restituer les résultats de campagnes aux équipes commerciales sous une forme lisible et exploitable.",
          finTitle: "Mediatrading / AdOps (Stage)",  // → finance.html
          finCompany: "leboncoin · Régie publicitaire",
          finPoint1: "Suivi d'un portefeuille de campagnes display et contrôle de la bonne exécution des engagements pris auprès des annonceurs.",
          finPoint2: "Production des bilans de campagnes : synthèse des performances et restitution aux équipes commerciales et aux clients.",
          finPoint3: "Interface entre le client et la régie tout au long de la campagne, garantissant la fiabilité de l'information transmise.",
        },
        kpn: {
        ...
        engoo: {                           // point1-4 → index + marketing.html | dataPoint → data.html | finTitle/finPoint → finance.html
          ...
          mkPoint1: "Concevoir des tableaux de bord automatisés sur Excel pour piloter la performance marketing, réduisant de 30% le temps de traitement des données.",
          mkPoint2: "Concevoir des contenus sur REDnote basée sur une veille des tendances, permettant d'accroître la visibilité (93,3%), l'engagement (89,1%) et le nombre d'abonnés (69,7%).",
          mkPoint3: "Réaliser des analyses de marché approfondies et une veille concurrentielle pour optimiser la stratégie marketing sur le segment du chinois simplifié.",
          ...
          stat2: "Abonnés",
          stat3: "Interactions",
          screenshot1: "assets/Excel_Engoo/Engoo Dashboard_FR.webp",
      ...
      portfolio: {                         // → voir sous-clés ci-dessus
        ...
        mkt: {                             // → portfolio-marketing.html
          ...
          aiesec: {
            ...
            body: "En 2025, j'ai piloté l'équipe marketing (4 personnes) pour le camp international YOLO d'AIESEC in NCCU. C'est un séjour entièrement en anglais destiné aux lycéens. J'ai conçu des visuels de campagne comme les affiches et les publications pour le recrutement de volontaires et de participants. On a recruté 15 volontaires et plus de 60 participants, dépassant l'objectif budgétaire de 53,7%.",
          ...
          board: {
            ...
            intro: "Chaque fiche donne le résultat obtenu avant le nom du projet. Cliquez sur une fiche pour ouvrir l'étude de cas correspondante.",
            p1Name: "Engoo · Dashboard Xiaohongshu",
            p1Cat: "Dashboard · Social Analytics",
            p1Lbl: "Vues sur 3 mois",
            p1Bar1: "Vues",
            p1Bar2: "Interactions",
            p1Bar3: "Abonnés",
            p1Scale: "Croissance sur 3 mois, jauges graduées de 0 à 100%.",
            p2Name: "Sephora · Intelligence Produit",
            p2Cat: "BCG · Beauty Analytics",
            p2Lbl: "Produits analysés",
            p2Bar1: "Note moyenne du catalogue",
            p2Chip1: "Avis clients traités",
            p2Chip2: "Lecture du portefeuille",
            p2Chip2Val: "Matrice BCG",
            p2Scale: "Jauge graduée de 0 à 5, échelle de notation Sephora.",
            p3Name: "Maison Beauté · Diagnostic Client",
            p3Cat: "Segmentation · ROI",
            p3Lbl: "Clients analysés",
            p3Bar1: "Conversion, campagne Response",
            p3Chip1: "Écart de dépense Mass vs Luxury",
            p3Chip2: "Valeur du client engagé",
            p3Scale: "Jauge graduée de 0 à 100% de la base ciblée.",
            p4Name: "Engoo · Rapport Hebdomadaire",
            p4Cat: "Reporting · Data Storytelling",
            p4Lbl: "Diapositives par semaine",
            p4Chip1: "Langues de diffusion",
            p4Chip2: "Cadence de production",
            p4Chip2Val: "Hebdomadaire",
            p4Chip3: "Destinataire",
            p4Chip3Val: "Équipe de direction",
            p4Scale: "Format du livrable remis chaque semaine pendant le stage.",
            p5Name: "AIESEC · Camp International YOLO",
            p5Cat: "Campagne · Direction Artistique",
            p5Lbl: "Objectif budgétaire dépassé",
            p5Chip1: "Participants accueillis",
            p5Chip2: "Volontaires recrutés",
            p5Chip3: "Équipe marketing pilotée",
            p5Scale: "Résultats de l'édition 2025 du camp, AIESEC in NCCU.",
            p6Name: "Club de Guzheng · Page Facebook",
            p6Cat: "Community Management",
            p6Lbl: "Places pourvues à chaque recrutement",
            p6Bar1: "Places pourvues",
            p6Bar2: "Fidélisation des membres",
            p6Scale: "Jauges graduées de 0 à 100% de l'effectif du club.",
          },
        ...
        data: {                            // → portfolio-data.html
          ...
          weekly: {
            num: "Reporting · Data Storytelling",
            tag: "PowerPoint · Data Storytelling · Reporting",
            title: "Engoo – Rapport Hebdomadaire XHS",
            desc: "Rapport hebdomadaire bilingue (EN/FR) synthétisant les performances du compte Xiaohongshu en 7 diapositives : indicateurs clés, tendances et recommandations éditoriales pour l'équipe de direction.",
            sitLbl: "Contexte & Objectif",
            sit: "Aucun format standardisé de reporting XHS au sein de l'équipe. Chaque semaine, la direction manquait de visibilité sur les tendances de performance. Objectif : produire un livrable hebdomadaire actionnable, lisible par un non-analyste, bilingue (EN/FR), en moins d'une heure.",
            actLbl: "Structure du Rapport",
            act: "7 diapositives structurées : récapitulatif hebdomadaire des KPIs, courbes de tendance, analyse des posts les plus performants, recommandations éditoriales et comparaison A/B des formats. Données issues du dashboard Excel XHS. Automatisation partielle via script Python de consolidation.",
            resLbl: "Impact & Utilisation",
            res: "Rapport adopté comme outil de pilotage hebdomadaire par l'équipe. Réduction du temps de préparation grâce à l'automatisation Python. Recommandations traduites directement en ajustements éditoriaux (+34% CTR après pivot de format).",
            btnFR: "Télécharger – Version française",
            btnEN: "Télécharger – Version anglaise",
            skillDashboard: "Voir le Dashboard XHS",
            statSlides: "Diapositives",
            statBilingue: "Bilingue EN/FR",
            statFreq: "Hebdomadaire",
          },
    ...
    en: {
      ...
      hero: {
        ...
        availabilityValue: "January 2027 (6-month gap year internship)",
      ...
      skills: {
        ...
        chipMarketingAutomation: "Marketing Automation",
        chipDesign: "Content Writing & Visual Design",
        ...
        filterContent: "Content & Community",
        blockContent: "Content & Community",
        subContent1: "Strategy",
        subContent2: "SMM (Social Media Marketing)",
        filterEvents: "Events",
        blockEvents: "Events & Coordination",
        chipEventManagement: "Event Management",
        chipEventHosting: "Hosting & Facilitation",
        chipVendorCoordination: "Vendor Coordination",
        ...
        chipGemini: "Gemini",
        chipVibeCoding: "Vibe Coding",
        subAITools: "Artificial Intelligence",
        subDevWeb: "Web Development",
        chipMicrosoftOffice: "Microsoft Office (Word · Excel · PowerPoint)",
        chipGoogleSuite: "Google Suite",
        chipNotion: "Notion",
        blockDataMarketing: "Data, Reporting & Automation",
      ...
      financeHero: {
        kicker: "Finance · Management Control · Analysis",
        title1: "Counting, checking",
        title2: "and making the numbers readable.",
        summary: "Finance and management control courses at emlyon (accounting, P&L analysis, modelling, variance analysis) and an economics minor at NCCU. In practice: monthly advertising budgets at KPN and tracking the commitments made to advertisers at leboncoin.",
        ctaPrimary: "Contact me",
        ctaSecondary: "View my experience",
      ...
      marketingHero: {
        kicker: "Content · Campaigns · Ad delivery",
        cordierTitle: "Campaign results",
        corde1: "+93.3% views · Engoo",
        corde2: "+89.1% interactions · Engoo",
        corde3: "+69.7% followers · Engoo",
        corde4: "+9.5% CTR · KPN",
        corde5: "+5.1% conversion rate · KPN",
        title1: "I create content",
        title2: "and I run its delivery.",
        summary: "At Engoo I ran the Xiaohongshu account for three months: +93.3% views and +69.7% followers. At KPN I monitored Meta and Google campaigns (+9.5% CTR, +5.1% conversion rate). Since July 2026 I have been launching and optimising display campaigns at leboncoin.",
      ...
      dataHero: {
        kicker: "Analysis · Reporting · Quantitative methods",
        title1: "Dashboards, regressions",
        title2: "and campaign reports.",
        summary: "Excel (TOSA 950/1000), Python, R, SQL, Power BI and Tableau. A daily 12-metric dashboard at Engoo, a regression study on Google ranking factors at KPN, and today the delivery reports for display campaigns at leboncoin.",
      ...
      teachingEngagement: {
        ...
        leboncoin: {
          period: "07/2026 – 01/2027",
          title: "Mediatrading / AdOps",
          company: "leboncoin · Advertising Sales House",
          point1: "Go-live of display campaigns and day-to-day monitoring of their delivery.",
          point2: "Tracking and optimisation of a portfolio of campaigns.",
          point3: "Go-live reports, end-of-campaign reviews and liaison with the sales teams.",
          mkPoint1: "Manage the go-live of display campaigns and the smooth running of their delivery.",
          mkPoint2: "Optimise a portfolio of live campaigns to secure media delivery objectives.",
          mkPoint3: "Produce end-of-campaign reviews to report performance back to advertisers.",
          mkPoint4: "Work hand in hand with the sales teams to keep exchanges smooth between the advertiser and the sales house.",
          dataPoint1: "Consolidate delivery data to produce go-live reports and end-of-campaign reviews.",
          dataPoint2: "Analyse delivery indicators across a portfolio of campaigns to identify optimisation levers.",
          dataPoint3: "Report campaign results back to the sales teams in a clear and actionable format.",
          finTitle: "Mediatrading / AdOps (Internship)",
          finCompany: "leboncoin · Advertising Sales House",
          finPoint1: "Monitored a portfolio of display campaigns and checked that commitments made to advertisers were properly delivered.",
          finPoint2: "Produced end-of-campaign reviews: performance summaries reported to the sales teams and clients.",
          finPoint3: "Acted as the interface between client and sales house throughout the campaign, ensuring the reliability of the information shared.",
        },
        kpn: {
          period: "01/2025 – 06/2025",
          ...
          finCompany: "KPN · Digital Marketing Agency, SEO, SEM & Facebook Advertising",
        ...
        engoo: {
          ...
          finCompany: "Engoo, DMM.com · International Online Language Learning Platform",
          ...
          stat2: "Followers",
          stat3: "Interactions",
          screenshot1: "assets/Excel_Engoo/Engoo Dashboard_EN.webp",
      ...
      portfolio: {
        ...
        mkt: {
          ...
          board: {
            ...
            intro: "Each card leads with the result before the project name. Click a card to open the matching case study.",
            p1Name: "Engoo · Xiaohongshu Dashboard",
            p1Cat: "Dashboard · Social Analytics",
            p1Lbl: "Views over 3 months",
            p1Bar1: "Views",
            p1Bar2: "Interactions",
            p1Bar3: "Followers",
            p1Scale: "Growth over 3 months, gauges scaled from 0 to 100%.",
            p2Name: "Sephora · Product Intelligence",
            p2Cat: "BCG · Beauty Analytics",
            p2Lbl: "Products analysed",
            p2Bar1: "Catalogue average rating",
            p2Chip1: "Customer reviews processed",
            p2Chip2: "Portfolio reading",
            p2Chip2Val: "BCG matrix",
            p2Scale: "Gauge scaled from 0 to 5, Sephora rating scale.",
            p3Name: "Maison Beauté · Customer Diagnostic",
            p3Cat: "Segmentation · ROI",
            p3Lbl: "Customers analysed",
            p3Bar1: "Conversion, Response campaign",
            p3Chip1: "Mass vs Luxury spending gap",
            p3Chip2: "Value of an engaged customer",
            p3Scale: "Gauge scaled from 0 to 100% of the targeted base.",
            p4Name: "Engoo · Weekly Report",
            p4Cat: "Reporting · Data Storytelling",
            p4Lbl: "Slides per week",
            p4Chip1: "Delivery languages",
            p4Chip2: "Production cadence",
            p4Chip2Val: "Weekly",
            p4Chip3: "Audience",
            p4Chip3Val: "Management team",
            p4Scale: "Format of the deliverable submitted every week during the internship.",
            p5Name: "AIESEC · YOLO International Camp",
            p5Cat: "Campaign · Art Direction",
            p5Lbl: "Budget target exceeded",
            p5Chip1: "Participants hosted",
            p5Chip2: "Volunteers recruited",
            p5Chip3: "Marketing team led",
            p5Scale: "Results of the 2025 edition of the camp, AIESEC in NCCU.",
            p6Name: "NCCU Guzheng Club · Facebook Page",
            p6Cat: "Community Management",
            p6Lbl: "Places filled at every recruitment",
            p6Bar1: "Places filled",
            p6Bar2: "Member retention",
            p6Scale: "Gauges scaled from 0 to 100% of the club's membership.",
          },
        ...
        data: {
          ...
          weekly: {
            num: "Reporting · Data Storytelling",
            tag: "PowerPoint · Data Storytelling · Reporting",
            title: "Engoo – XHS Weekly Report",
            desc: "Bilingual weekly report (EN/FR) distilling Xiaohongshu account performance into 7 actionable slides: key metrics, trends and editorial recommendations for the management team.",
            sitLbl: "Context & Objective",
            sit: "No standardised XHS reporting format within the team. Each week, management lacked visibility into performance trends. Objective: produce a weekly bilingual (EN/FR) deliverable, readable by a non-analyst, in under one hour.",
            actLbl: "Report Structure",
            act: "7 structured slides: weekly KPI summary, trend lines, top-performing post analysis, editorial recommendations and A/B format comparison. Data sourced from the XHS Excel dashboard. Partial automation via Python consolidation script.",
            resLbl: "Impact & Usage",
            res: "Report adopted as the team's weekly management tool. Preparation time reduced through Python automation. Recommendations translated directly into editorial adjustments (+34% CTR after format pivot).",
            btnFR: "Download – French version",
            btnEN: "Download – English version",
            skillDashboard: "View XHS Dashboard",
            statSlides: "Slides",
            statBilingue: "Bilingual EN/FR",
            statFreq: "Weekly",
          },
      ...
      volunteer: {
        ...
        aiesec: {
          ...
          stat3: "Above target",
          finTitle: "Member",
          finOrg: "AIESEC in NCCU · Global non-profit coordinating international volunteer programmes",
    ...
    zh: {
      ...
      hero: {
        ...
        availabilityValue: "2027 年 1 月（6 個月間隔年實習）",
        ctaPrimary: "聯絡我",
        ctaSecondary: "查看我的經歷",
      ...
      skills: {
        title: "技能專長",
        subtitle: "以數據分析、數位行銷與國際視野為核心，構建跨領域技能體系。",
        filterAll: "全部",
        previewTitle: "技能詳情",
      ...
      education: {
        title: "學歷背景",
        subtitle: "橫跨台法兩地的國際求學歷程，涵蓋管理、財務與語言多元領域。",
        emlyon: {
          period: "2025/09 –至今",
          title: "管理碩士（大學校課程）",
          school: "emlyon business school",
        ...
        nccu: {
          ...
          point2: "擔任古箏社公關；AIESEC 成員，負責帶領專案行銷小組。",
          gpa: "4.22 / 4.3",
          statRanking: "排名",
      ...
      financeHero: {
        ...
        title1: "算清楚、核對過，",
        title2: "再把數字講明白。",
        summary: "在 emlyon 修習財務與管理會計課程（會計、損益分析、財務建模、差異分析），並於政大輔修經濟。實務方面：在 KPN 管理每月廣告預算，在 leboncoin 追蹤對廣告主承諾的執行情況。",
        ctaPrimary: "聯絡我",
        ctaSecondary: "查看我的經歷",
        cardRole: "財務 & 策略顧問",
      ...
      marketingHero: {
        kicker: "內容 · 廣告活動 · 投放",
        cordierTitle: "廣告活動成果",
        corde1: "瀏覽量 +93.3% · Engoo",
        corde2: "互動量 +89.1% · Engoo",
        corde3: "追蹤者 +69.7% · Engoo",
        corde4: "CTR +9.5% · KPN",
        corde5: "轉換率 +5.1% · KPN",
        title1: "我做內容，",
        title2: "也負責讓它被看見。",
        summary: "在 Engoo 經營小紅書帳號三個月：瀏覽量 +93.3%、追蹤者 +69.7%。在 KPN 追蹤 Meta 與 Google 廣告活動（CTR +9.5%、轉換率 +5.1%）。2026 年 7 月起在 leboncoin 負責 display 廣告的上線與優化。",
        ctaPrimary: "查看我的作品集",
        ctaSecondary: "聯絡我",
        cardRole: "數位行銷 & 內容創作",
      ...
      dataHero: {
        ...
        title1: "儀表板、迴歸分析，",
        title2: "還有廣告成效報告。",
        summary: "Excel（TOSA 950/1000）、Python、R、SQL、Power BI 與 Tableau。在 Engoo 建立每日 12 項指標的儀表板，在 KPN 以迴歸分析研究 Google 排名因素，現在則負責 leboncoin display 廣告的投放報告。",
        ctaPrimary: "查看作品集",
        ctaSecondary: "查看我的經歷",
        cardRole: "數據分析 & 市場研究",
      ...
      teachingEngagement: {
        ...
        subtitle: "語言指導計畫、文化沉浸與國際交流活動。",
            ...
            experience: {
        title: "工作經歷",
        subtitle: "數位行銷、數據分析與專案協調領域的精選工作經歷。",
        leboncoin: {
          period: "2026/07 –2027/01",
          title: "廣告投放交易 / AdOps",
          company: "leboncoin · 廣告代理商",
          point1: "負責 display 廣告活動上線及投放的日常營運追蹤。",
          point2: "追蹤並優化廣告活動組合。",
          point3: "製作廣告上線報告、活動成效總結報告，並擔任與業務團隊的溝通窗口。",
          mkPoint1: "主導 display 廣告活動上線，確保投放順利進行。",
          mkPoint2: "優化投放中的廣告活動組合，確保達成媒體投放目標。",
          mkPoint3: "製作活動成效總結報告，向廣告主呈現投放成果。",
          mkPoint4: "與業務團隊緊密協作，讓廣告主與廣告代理商之間的溝通更順暢。",
          dataPoint1: "彙整投放數據，製作廣告上線報告與活動成效總結報告。",
          dataPoint2: "分析廣告活動組合的投放指標，找出可優化的施力點。",
          dataPoint3: "以清楚且可執行的形式，向業務團隊回報廣告活動成果。",
          finTitle: "廣告投放交易 / AdOps（實習）",
          finCompany: "leboncoin · 廣告代理商",
          finPoint1: "追蹤 display 廣告活動組合，確認對廣告主承諾的投放內容確實執行。",
          finPoint2: "製作活動成效總結報告，彙整投放成果並回報業務團隊與客戶。",
          finPoint3: "在活動期間擔任客戶與廣告代理商之間的窗口，確保傳遞資訊的準確性。",
        },
        kpn: {
      ...
      portfolio: {
        ...
        mkt: {
          ...
          board: {
            title: "專案成果",
            intro: "每張卡片先呈現成果，再標示專案名稱。點擊卡片即可開啟對應的案例研究。",
            p1Name: "Engoo · 小紅書儀表板",
            p1Cat: "儀表板 · 社群分析",
            p1Lbl: "三個月瀏覽量成長",
            p1Bar1: "瀏覽量",
            ...
            p2Chip2: "產品組合判讀",
            p2Chip2Val: "BCG 矩陣",
            p2Scale: "刻度為 0 至 5，採 Sephora 評分制。",
            p3Name: "Maison Beauté · 顧客診斷",
            p3Cat: "客群分群 · 投資報酬",
            p3Lbl: "分析顧客數",
            p3Bar1: "Response 活動轉換率",
            p3Chip1: "大眾與奢華客群消費差距",
            p3Chip2: "高互動顧客價值",
            p3Scale: "刻度為目標客群的 0 至 100%。",
            p4Name: "Engoo · 每週報告",
            p4Cat: "報告 · 數據敘事",
            p4Lbl: "每週投影片頁數",
            p4Chip1: "發布語言",
            ...
            p4Chip3: "報告對象",
            p4Chip3Val: "管理團隊",
            p4Scale: "實習期間每週交付的報告格式。",
            p5Name: "AIESEC · YOLO 國際營隊",
            p5Cat: "行銷活動 · 視覺方向",
            p5Lbl: "超越預算目標",
            p5Chip1: "參與學員人數",
            p5Chip2: "志工招募人數",
            p5Chip3: "帶領行銷團隊人數",
            p5Scale: "政大 AIESEC 2025 年營隊成果。",
            p6Name: "政大古箏社 · Facebook 專頁",
            p6Cat: "社群管理",
            p6Lbl: "每次招生名額額滿率",
            p6Bar1: "名額額滿率",
            p6Bar2: "社員留存率",
            p6Scale: "刻度為社團人數的 0 至 100%。",
          },
          footerBack: "← 返回行銷頁",
          footerNext: "數據與研究作品集 →",
        },
        data: {
          ...
          weekly: {
            num: "報告 · 數據敘事",
            tag: "PowerPoint · 數據敘事 · Reporting",
            title: "Engoo – 小紅書週報",
            desc: "雙語週報（EN/FR），將小紅書帳號表現濃縮為 7 張簡報：關鍵指標、趨勢分析與給管理層的內容建議。",
            sitLbl: "背景與目標",
            sit: "團隊缺乏標準化的小紅書報告格式，管理層每週對績效趨勢缺乏能見度。目標：在一小時內產出一份非分析師也能讀懂的雙語（EN/FR）週報。",
            actLbl: "報告架構",
            act: "7 張結構化簡報：週 KPI 摘要、趨勢曲線、高績效貼文分析、內容建議與 A/B 格式比較。數據來源：Excel 小紅書儀表板，搭配 Python 自動化整合腳本。",
            resLbl: "影響與應用",
            res: "週報成為團隊管理工具，Python 自動化縮短製作時間，建議直接轉化為內容調整（格式轉型後 CTR +34%）。",
            btnFR: "下載 – 法文版",
            btnEN: "下載 – 英文版",
            skillDashboard: "查看小紅書儀表板",
            statSlides: "張簡報",
            statBilingue: "英法雙語",
            statFreq: "每週發布",
          },
      ...
      extracurricular: {
        title: "課外活動",
        subtitle: "參與各類社團與組織，在學業之餘拓展視野與技能。",
        guzheng: {
      ...
      volunteer: {
        ...
        aiesec: {
          ...
          stat3: "超越目標",
          finTitle: "成員",
          finOrg: "AIESEC in NCCU · 協調國際志工計畫的全球非營利組織",
      ...
      contact: {
        heading: "聯絡我",
        intro:
          "有實習、專案或合作方面的機會嗎？歡迎傳訊息給我，我很樂意進一步交流。",
        labelEmail: "電子郵件",
        labelPhone: "電話",
        labelLocation: "所在地",
        formName: "姓名",
  ...
  const skillData = {
    ...
    "data-python": {
      ...
      en: {
        ...
        proofs: [
          ...
          { type: "Experience", title: "Research Assistant", org: "Institute of International Relations, NCCU", meta: [], points: ["Data collection, cleaning and processing for academic research."], actions: [{ label: "View experience", href: "#exp-research" }] },
          { type: "Course", title: "Programming 101 (Python)", org: "National Chengchi University (NCCU)", meta: ["Academic course"], points: ["Programming fundamentals and application to data analysis."] },
        ],
      },
      proofs: [
        {
          type: "Portfolio",
          title: "Rapport Hebdomadaire XHS – Synthèse & Reporting",
          org: "Engoo, DMM.com · Plateforme mondiale de cours de langue",
          meta: ["Reporting", "Synthèse", "PowerPoint", "Data Storytelling"],
          points: [
            "Rapport hebdomadaire bilingue (EN/FR) synthétisant les performances du compte Xiaohongshu en 7 diapositives : indicateurs clés, tendances hebdomadaires et recommandations éditoriales pour l'équipe de direction.",
          ],
          actions: [
        ...
        {
          type: "Stage",
          title: "Assistante Marketing – Consolidation de Données XHS",
          org: "Engoo, DMM.com · Plateforme mondiale de cours de langue",
          meta: [],
          points: ["Développement d'un script Python d'automatisation de la consolidation des données Xiaohongshu quotidiennes, réduisant le temps de reporting."],
    ...
    "mkt-gkp": {
      ...
      proofs: [
        { type: "Stage", title: "Assistante Marketing Digital", org: "KPN · Agence de marketing digital", meta: [], points: ["Identification et sélection de mots-clés via Google Keyword Planner pour optimiser le ciblage et les enchères des campagnes Google Ads."], actions: [{ label: "Voir l'expérience", href: "#exp-kpn" }] },
      ],
      en: { title: "Google Keyword Planner", text: "Keyword research, search volume estimation and bid planning for Google Ads campaigns.", proofs: [
        { type: "Internship", title: "Digital Marketing Assistant", org: "KPN · Digital Marketing Agency", meta: [], points: ["Used Google Keyword Planner to identify and select keywords for targeting and bid optimisation across Google Ads campaigns."], actions: [{ label: "View experience", href: "#exp-kpn" }] },
      ]},
    },
    "mkt-gtrends": {
      title: "Google Trends",
      ...
      proofs: [
        { type: "Stage", title: "Assistante Marketing Digital", org: "KPN · Agence de marketing digital", meta: [], points: ["Utilisation de Google Trends pour identifier les tendances sectorielles et orienter la production de contenus web à fort potentiel SEO."], actions: [{ label: "Voir l'expérience", href: "#exp-kpn" }] },
      ],
      en: { title: "Google Trends", text: "Search trend analysis to anticipate high-potential topics, refine content strategy and align the editorial calendar with demand.", proofs: [
        { type: "Internship", title: "Digital Marketing Assistant", org: "KPN · Digital Marketing Agency", meta: [], points: ["Used Google Trends to identify industry trends and guide web content production with strong SEO potential."], actions: [{ label: "View experience", href: "#exp-kpn" }] },
      ]},
    },
    "mkt-semrush": {
      title: "Semrush",
      ...
      proofs: [
        { type: "Stage", title: "Assistante Marketing Digital", org: "KPN · Agence de marketing digital", meta: [], points: ["Utilisation de Semrush pour l'audit de sites clients, l'analyse concurrentielle et le suivi du positionnement des articles dans les résultats de recherche."], actions: [{ label: "Voir l'expérience", href: "#exp-kpn" }] },
      ],
      en: { title: "Semrush", text: "Site audit, competitor analysis, rank tracking and keyword opportunity identification.", proofs: [
        { type: "Internship", title: "Digital Marketing Assistant", org: "KPN · Digital Marketing Agency", meta: [], points: ["Used Semrush to audit client websites, analyse competitors and track article rankings in search results."], actions: [{ label: "View experience", href: "#exp-kpn" }] },
      ]},
    },
    "mkt-sea": {
      title: "Google Ads",
      ...
      proofs: [
        ...
        },
        {
          ...
          actions: [{ label: "Ouvrir le certificat", href: "certificates/Google%20Ads%20%E6%90%9C%E5%B0%8B%E5%BB%A3%E5%91%8A%E8%AA%8D%E8%AD%89.webp" }],
        },
        {
          type: "Certification",
          ...
          actions: [{ label: "Ouvrir le certificat", href: "certificates/Google%20Ads%20%E5%BD%B1%E7%89%87%E5%BB%A3%E5%91%8A%E8%AA%8D%E8%AD%89.webp" }],
        },
        {
          type: "Certification",
          ...
          actions: [{ label: "Ouvrir le certificat", href: "certificates/AI%20技術輔助高效廣告認證.webp" }],
        },
      ],
    },
    "mkt-social": {
    ...
    "mkt-design": {
      ...
      proofs: [
        ...
        },
        {
          ...
          actions: [{ label: "Ouvrir le certificat", href: "certificates/Google%20Ads%20%E5%BB%A3%E5%91%8A%E7%B4%A0%E6%9D%90%E8%AA%8D%E8%AD%89.webp" }],
        },
      ],
    },
    "prog-python": {
      ...
      proofs: [
        {
          ...
          actions: [{ label: "Ouvrir le certificat", href: "certificates/JLPT%20N1.webp" }],
        },
        {
          type: "Activité",
    ...
    "mkt-event-management": {
      ...
      proofs: [
        ...
        { type: "Expérience Associative", title: "Membre – AIESEC in NCCU", org: "AIESEC", meta: ["Événementiel"], points: ["Coordination de l'organisation d'un camp d'anglais accueillant 60+ participants et 15 volontaires internationaux."] },
      ],
      en: { title: "Event Management", text: "Planning and logistical coordination of events (camps, conferences, seminars): programme design, participant management and operational follow-up.", proofs: [
        ...
        { type: "Student Association", title: "Member – AIESEC in NCCU", org: "AIESEC", meta: ["Events"], points: ["Coordinated organisation of an English camp hosting 60+ participants and 15 international volunteers."] },
      ]},
    },
    "mkt-event-hosting": {
