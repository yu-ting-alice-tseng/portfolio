  ...
  const translations = {
    fr: {
      ...
      teachingEngagement: {
        ...
        engoo: {
          ...
          showcaseTitle1: "Tableau de bord de performance",
          showcaseDesc1: "Suivi des KPIs, comparaison de périodes A/B et graphiques d'évolution",
          showcaseTitle2: "Données d'origine",
          showcaseDesc2: "Métriques quotidiennes collectées et structurées pour l'analyse",
        },
        teaching: {
    ...
    en: {
      ...
      booking: {
        ...
        responseValue: "Within 24 h by email",
      ...
      teachingEngagement: {
        ...
        engoo: {
          ...
          showcaseTitle1: "Performance Dashboard",
          showcaseDesc1: "KPI tracking, period-over-period comparison and trend charts",
          showcaseTitle2: "Raw Data",
          showcaseDesc2: "Daily metrics collected and structured for analysis",
        },
        teaching: {
          period: "07/2023 – 12/2023 · 07/2024 – 04/2025",
    ...
    zh: {
      ...
      booking: {
        ...
        navCta: "預約課程",
        durationLabel: "課程時長",
        durationValue: "30 分鐘 · 45 分鐘 · 60 分鐘",
        formatLabel: "上課形式",
        formatValue: "線上（Zoom / Google Meet）",
        langLabel: "授課語言",
        langValue: "英語 · 法語 · 中文",
        responseLabel: "回覆時間",
        responseValue: "24小時內以Email回覆",
        fieldName: "您的姓名",
        fieldNamePh: "王小明",
        fieldEmail: "Email",
      ...
      teachingEngagement: {
        ...
        engoo: {
          ...
          showcaseTitle1: "數據儀表板",
          showcaseDesc1: "KPI 追蹤、前後期數據對比與趨勢圖表",
          showcaseTitle2: "原始數據",
          showcaseDesc2: "逐日蒐集並整理的各項小紅書指標",
        },
        teaching: {
